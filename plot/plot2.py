...
caterpillar.plot(Cat_x_pos, CatK2, marker='o', markersize=12, linestyle='-', linewidth=2.5, label='K2', color='#69C0FF')
caterpillar.plot(Cat_x_pos, CatK3, marker='s', markersize=12, linestyle='--', linewidth=2.5, label='K3', color='#95DE64')
caterpillar.plot(Cat_x_pos, CatK4, marker='^', markersize=12, linestyle='-.', linewidth=2.5, label='K4', color='#FFEB6B')
caterpillar.plot(Cat_x_pos, CatK5, marker='v', markersize=12, linestyle=':', linewidth=2.5, label='K5', color='#FFBC5C')
caterpillar.plot(Cat_x_pos, CatK6, marker='X', markersize=12, linestyle=':', linewidth=2.5, label='K6', color="#B53EF5")
caterpillar.plot(Cat_x_pos, CatK7, marker='D', markersize=12, linestyle='--', linewidth=2.5, label='K7', color='#FF6B6B')
caterpillar.plot(Cat_x_pos, CatK8, marker='o', markersize=12, linestyle='--', linewidth=2.5, label='K8', color='#FF929D')
...
fullTree.plot(Full_x_pos, FullK2, marker='o', markersize=12, linestyle='-', linewidth=2.5, label='K2', color='#69C0FF')
fullTree.plot(Full_x_pos, FullK3, marker='s', markersize=12, linestyle='--', linewidth=2.5, label='K3', color='#95DE64')
fullTree.plot(Full_x_pos, FullK4, marker='^', markersize=12, linestyle='-.', linewidth=2.5, label='K4', color='#FFEB6B')
fullTree.plot(Full_x_pos, FullK5, marker='v', markersize=12, linestyle=':', linewidth=2.5, label='K5', color='#FFBC5C')
fullTree.plot(Full_x_pos, FullK6, marker='X', markersize=12, linestyle=':', linewidth=2.5, label='K6', color="#B53EF5")
fullTree.plot(Full_x_pos, FullK7, marker='D', markersize=12, linestyle='--', linewidth=2.5, label='K7', color='#FF6B6B')
