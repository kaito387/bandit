...
caterpillar.plot(Cat_x_pos, CatPS95, marker='v', markersize=12, linestyle=':', linewidth=7.5, label='ASH-0.95', color='#B94F67')
caterpillar.plot(Cat_x_pos, CatPS98, marker='X', markersize=12, linestyle='-', linewidth=7.5, label='ASH-0.98', color="#FF528D")
caterpillar.plot(Cat_x_pos, CatPS100, marker='o', markersize=12, linestyle='--', linewidth=7.5, label='ASH-1.00', color='#B53EF5')
...
plt.savefig('sim_algo_vs_depth_caterpillar_only.pdf', dpi=300, bbox_inches='tight')
plt.show()